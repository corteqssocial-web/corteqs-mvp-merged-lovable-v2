...
const Founders1000 = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <main>
        <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100 pt-16">
          ...
          <div className="container mx-auto px-4 py-20 lg:py-28 relative z-10">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                ...
                restoranları, dernekleri, vakıfları, okulları, medya kuruluşlarını, içerik üreticilerini ve
                profesyonelleri şehir şehir görünür kılmak için kuruluyor.
              </p>

              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
                {stats.map((s) => (
                  <div key={s.label} className="rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm p-5 hover:bg-white/10 hover:border-amber-400/30 transition-all">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
                <button onClick={openForm} className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 text-slate-900 font-bold text-lg hover:from-amber-400 hover:to-yellow-300 transition-all shadow-xl shadow-amber-500/30">
            ...
            <div className="mb-20">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {eligibleCategories.map((cat) => (
                  <div key={cat.title} className="group p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-amber-400/40 hover:bg-white/[0.07] transition-all">
            ...
            <div className="mb-20">
              <div className="text-center max-w-3xl mx-auto mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Founding Verified User Avantajları</h2>
                <p className="text-slate-400 text-lg">Erken katılan, erken konumlanır. İşte size özel ayrıcalıklar:</p>
              </div>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
                {benefits.map((b) => (
                  <div key={b.text} className="flex items-start gap-4 p-5 rounded-xl bg-gradient-to-br from-white/[0.07] to-white/[0.02] border border-white/10 hover:border-amber-400/30 transition-all">
            ...
            <div className="mb-20">
              <div className="text-center max-w-3xl mx-auto mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Erken Dönem Üyelik</h2>
              ...
              <div className="max-w-2xl mx-auto">
                <div className="relative rounded-3xl bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-amber-400/40 p-8 md:p-10 shadow-2xl shadow-amber-500/10 backdrop-blur-sm">
                  ...
                  <div className="text-center mb-6">
                    <p className="text-amber-300 text-sm font-semibold uppercase tracking-wider mb-2">Founding 1000 Özel Yıllık Üyelik</p>
                    <div className="flex items-baseline justify-center gap-2">
                      <span className="text-6xl md:text-7xl font-extrabold bg-gradient-to-r from-amber-400 to-yellow-300 bg-clip-text text-transparent">€99</span>
                  ...
                  <div className="rounded-xl bg-white/5 border border-white/10 p-4 mb-6 space-y-2 text-sm">
                    <div className="flex justify-between text-slate-300"><span>Standart üyelik</span><span>Aylık €10</span></div>
                    <div className="flex justify-between text-slate-300"><span>Yıllık normal değer</span><span className="line-through text-slate-500">€120</span></div>
                    <div className="flex justify-between text-amber-300 font-bold pt-2 border-t border-white/10"><span>Founding 1000 özel</span><span>€99</span></div>
                  </div>
                  ...
                  <p className="text-xs text-slate-400 mb-6 leading-relaxed text-center">
                    ...
                    CorteQS'in <span className="font-semibold text-white">29 Ekim full açılış</span> tarihinden itibaren başlar.
                  </p>
                  <button onClick={openForm} className="group w-full inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 text-slate-900 font-bold text-lg hover:from-amber-400 hover:to-yellow-300 transition-all shadow-xl shadow-amber-500/30">
                    Founding 1000'e Katıl
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </button>
                </div>
            ...
            <div className="mb-20">
              <div className="text-center max-w-3xl mx-auto mb-10">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Neden Şimdi Katılmalısınız?</h2>
                <p className="text-slate-300 text-lg leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 max-w-5xl mx-auto">
                {exampleCities.map((c) => (
                  <div key={c} className="px-5 py-4 rounded-xl bg-gradient-to-r from-white/[0.07] to-transparent border border-white/10 hover:border-amber-400/30 hover:from-amber-500/[0.07] transition-all flex items-center gap-3">
            ...
            <div className="mb-20">
              <div className="text-center max-w-3xl mx-auto mb-10">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">5 Kıta, 1000 Kurucu Katılımcı</h2>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-5xl mx-auto">
                {continents.map((c) => (
                  <div key={c.name} className="text-center p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-amber-400/40 hover:bg-white/10 transition-all">
              ...
              <p className="text-center text-xs text-slate-400 mt-6">Amerika bölgesi, Kuzey ve Güney Amerika'yı kapsar.</p>
            </div>
            ...
            <div className="max-w-3xl mx-auto text-center rounded-3xl bg-gradient-to-br from-amber-500/10 via-yellow-400/5 to-amber-600/10 border border-amber-400/30 p-10 md:p-14">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4 leading-tight">
                ...
                <span className="bg-gradient-to-r from-amber-400 to-yellow-300 bg-clip-text text-transparent">ilk görünenlerden</span>{" "}
                biri olun.
              </h2>
              <p className="text-slate-300 text-lg mb-8 leading-relaxed">
                CorteQS Founding 1000'e katılın ve global Türk diasporasının dijital haritasında erken pozisyon alın.
              </p>
              <button onClick={openForm} className="group inline-flex items-center justify-center gap-2 px-10 py-4 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 text-slate-900 font-bold text-lg hover:from-amber-400 hover:to-yellow-300 transition-all shadow-xl shadow-amber-500/30">
                Founding 1000'e Katıl
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
            </div>
