      ...
      <div className="container mx-auto px-4 pt-20 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <Link to="/auth">
              <Button size="lg" className="w-full text-xs sm:text-sm px-3 py-3 h-auto min-h-[3.75rem] bg-turquoise hover:bg-turquoise-light text-primary-foreground shadow-lg gap-2 leading-snug whitespace-normal text-center flex items-center justify-center">
                <UserPlus className="h-4 w-4 shrink-0" />
                <span className="whitespace-normal text-center">Kaydol — Diaspora Pasaportun Çıksın 🪪</span>
              </Button>
            </Link>
